...
class PetFriends:
    ...
    def post_api_create_pet_without_photo(self, auth_key: json, name: str, animal_type: str,
                                   age: str) -> json:
    ...
    def post_api_create_pet_without_name(self, auth_key: json, name: str, animal_type: str,
                                   age: str) -> json:
